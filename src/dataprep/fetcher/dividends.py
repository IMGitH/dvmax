...
# TODO - handle splits in all of the features / raw data

def fetch_splits(ticker: str) -> pl.DataFrame:
...
def fetch_dividends(
    ...
    """
    Fetches dividend data using FMP API with Yahoo Finance fallback, and applies split adjustments.
    """
    # Resolve dates
